const contractAddress = "0xb13D620d50812C60c7ced405b160597C4E841Fe6"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Shero Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "The Shero Club NFT Project is a shoutout to amazing everyday sheroes";
...
const button_presale_already_minted = "Join The Club";
